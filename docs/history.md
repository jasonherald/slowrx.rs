# Pre-V2 Release History

Earlier release notes that pre-date the V2 mode-coverage work
(0.3.0+). Kept here for historical interest; the active
[`CHANGELOG.md`](../CHANGELOG.md) covers `0.3.0` and forward.

This file follows the same [Keep a Changelog](https://keepachangelog.com/en/1.1.0/)
format as the active changelog.
